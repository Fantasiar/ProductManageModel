...
<body>
        ...
        <div style="background-color: #BFEFFF;border: 1px solid cornflowerblue;border-radius: 8px;height: 500px;margin-top: 40px;width: 730px;margin-left: 30px">
            <form action="${pageContext.request.contextPath}/addFirstCategoryServlet" method="post" class="form-horizon" role="form">
                ...
                <div class="form-group" style="margin-top: 25px">
                	...
                	<span id="checkFc" style="float: right;margin-top: -30px;margin-right: 10px"></span>
                </div>
                <div class="form-group" style="margin-top: 30px">
                    <textarea id="fc_info" name="fc_info" maxlength="25" class="form-control" rows="8" placeholder="请输入该分类的描述信息（不超过25个字）" style="width:500px;border-radius: 6px;margin-left: 115px"></textarea>
               		<span id="checkFcInfo" style="float: right;margin-top: -150px;margin-right: -15px"></span>
                </div>
                <div class="form-group" style="margin-top: 30px">
